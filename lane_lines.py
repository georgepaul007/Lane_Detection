...
st.title('This is our Python Lane Detection Application')
st.markdown('You can just upload a video and instantly it will converted into a video with the lanes detected and you can download it!')

st.header('If you need to detect lanes in a video')

uploaded_input_video = st.file_uploader("Choose an input video", key = "input_video", type = 'mp4')
uploaded_output_video = st.file_uploader("Choose an output Video", type = 'mp4')
...
uploaded_input_image = st.file_uploader("Choose an input image", key = "input_image", type = 'jpg')
...
if uploaded_output_image is not None:
	...
	# 		data = file,
	# 		file_name = uploaded_output_image,
	# 		mime = "image/png"
	# 	)
